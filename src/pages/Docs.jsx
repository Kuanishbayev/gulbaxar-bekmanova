    ...
    <div className="min-h-screen bg-stone-50">
        <div className="max-w-[1280px] mx-auto flex flex-col-reverse md:flex-row items-center gap-4">
            <div className="md:w-1/2 px-4 md:px-0">
                ...
                <button className="py-2 px-4 border border-blue-500 mb-4">Batafsil...</button>
            </div>
            <div>
                <img src="https://assets-global.website-files.com/5f8e953a227ca157f67b8a07/6252ce379bdbc967b10cc4ad_E8CcZAlXMAoLLnL.jpg" alt="Virtual Humans" />
            </div>
        </div>
    </div>
  )
